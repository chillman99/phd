...
public class Reduce3DPeaks_temp {
...
//CIH - ADDED			   
	...
	public void MatchPeaks(ArrayList<PointMountain> mountainPoints) {
		...
		double iRT = mountainPoints.get(i).getRetentionTime();
		int chargeMatch = 0;
		
		while (peakFound == 0 && j <= endLoop-2 && mountainPoints.get(j).getRetentionTime() == currRT				
			   ) {
////System.out.println("Inner Loop Number:" + inLoopNum);	
			if (iCharge != mountainPoints.get(j).getCharge() & chargeMatch ==1) break;
			else if (iCharge != mountainPoints.get(j).getCharge()
					|| iCharge * iWpm
					> (mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm()) + 
					(mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm() * 0.000007)
					)
			{
				j++;
				continue;
...
//			
//			if (iCharge * iWpm
//					< (mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm()) + (mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm() * 0.000007)){				
//				break;
//			} 
			chargeMatch = 1;		
			iterations++;
			...
			//if (mountainPoints.get(i).matches(mountainPoints.get(j)) && peakFound == 0) {
		     //if (mountainPoints.get(i).matches(mountainPoints.get(j)) && peakFound == 0) {	
		    	...
		    	// if ((mountainPoints.get(i).getRetentionTime() != mountainPoints.get(j).getRetentionTime()) &&
		    	//		 mountainPoints.get(i).getCharge() * mountainPoints.get(i).getWpm() >= 
		    	//		 ((mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm()) - (mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm() * 0.000007))  
		    	//			&&  (mountainPoints.get(i).getCharge() * mountainPoints.get(i).getWpm()
		    	//					<= (mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm()) + (mountainPoints.get(j).getCharge() * mountainPoints.get(j).getWpm() * 0.000007))  
		    	//					)
...
//if (mountainID == 83){System.out.println("**STMOUNTAIN 83*****"+mountainID + "\t" + i + ":" + j + "\t" + mountainPoints.get(i).getWpm() + "\t" + mountainPoints.get(j).getWpm() + "\t" + mountainPoints.get(i).getRetentionTime());}
...
////System.out.println("Inner Loop Count:"+i + "\t" +  + inLoopNum);	
		    	 ...
		    	 {	 
    		 			...
    		 			if (mountainPoints.get(matchpos1).getWpm() - iWpm > mountainPoints.get(j).getWpm() - iWpm){
			    		 		matchpos1 = j;			
...
//if (mountainID == 927 )//System.out.println("MountainID j SET:"+i + "\t" + j + "\t" + mountainPoints.get(j).getWpm() + "\t" + mountainID);    		 		
        		 	...
        		 	mountainPoints.get(j).setMountainID(mountainID);    		 		
	   		 			...
	   		 			//mountainPoints.get(i).setMountainID(mountainID);				    		 		 	
		    		 	//mountainPoints.get(j).setMountainID(mountainID);
//if (mountainID == 83){System.out.println("****MOUNTAIN 83*****"+mountainID + "\t" + i + ":" + j + "\t" + mountainPoints.get(i).getWpm() + "\t" + mountainPoints.get(j).getWpm() + "\t" + mountainPoints.get(i).getRetentionTime());}
